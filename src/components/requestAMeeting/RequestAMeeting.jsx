...
export default function RequestAMeeting() {
  return (
    <section className="request_a_meeting mx-[4vw] py-10 my-10 bg-green-clr rounded-[20px] md:rounded-[40px]  flex flex-col md:flex-row items-start md:items-center gap-10">
