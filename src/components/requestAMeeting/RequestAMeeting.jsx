...
export default function RequestAMeeting() {
  return (
    <div className="px-[4vw]">
      <section className="request_a_meeting py-10 my-10 bg-green-clr rounded-[20px] md:rounded-[40px] flex flex-col md:flex-row items-start md:items-center gap-10 w-full max-w-screen-lg mx-auto">
